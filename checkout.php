...
if(isset($_POST['submit'])){
	...
	if($payment_type=='instamojo'){
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER,
			array("X-Api-Key:test_8b88f0f15220effeff2793f05d4","X-Auth-Token:test_020416773f149fff0ca681fa0aa")
		);
		$payload = Array(
			'purpose' => 'Buy Product',
			'amount' => $total_price,
			...
			'redirect_url' => 'http://127.0.0.1/AgroCenterWebsite/payment_complete.php',
			'send_email' => true,
			'send_sms' => false,
			'email' => $userArr['email'],
